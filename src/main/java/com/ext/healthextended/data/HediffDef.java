...
public enum HediffDef {
    ...
    FRACTURE("Fracture", 0.07f, 4, true, true),
    CRUSH("Crush", 0.05f, 5, true, true),
    BITE("Bite", 0.08f, 3, true, true),
    CUT("Cut", 0.12f, 3, true, true),
    DEEP_CUT("Deep Cut", 0.08f, 4, true, true),
    ARROW_WOUND("Arrow Wound", 0.08f, 3, true, true),
    STAB("Stab", 0.08f, 3, true, true),
    PIERCING_WOUND("Piercing Wound", 0.10f, 3, true, true),
    MINOR_SCRATCH("Scratch", 0.24f, 1, true, true),
    BURN("Burn", 0.10f, 3, true, true),
    FROSTBITE("Frostbite", 0.07f, 2, true, true),
    ELECTRICAL_BURN("Electrical Burn", 0.05f, 4, true, true),
